...
module.exports = "<app-login *ngIf=\"!userService.isUserLoggedIn()\"></app-login>\n<app-sidebar *ngIf=\"userService.isUserLoggedIn()\">\n  <router-outlet></router-outlet>\n</app-sidebar>\n"
...
/* harmony import */ var _authorization_login_login_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./authorization/login/login.component */ "./src/app/authorization/login/login.component.ts");
/* harmony import */ var _common_api_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./common/api.service */ "./src/app/common/api.service.ts");
/* harmony import */ var _deployment_deployment_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./deployment/deployment.module */ "./src/app/deployment/deployment.module.ts");
/* harmony import */ var _deployment_deployment_list_deployment_list_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./deployment/deployment-list/deployment-list.component */ "./src/app/deployment/deployment-list/deployment-list.component.ts");
/* harmony import */ var _authorization_login_guard__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./authorization/login.guard */ "./src/app/authorization/login.guard.ts");
/* harmony import */ var _server_state_server_state_list_server_state_list_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./server-state/server-state-list/server-state-list.component */ "./src/app/server-state/server-state-list/server-state-list.component.ts");
/* harmony import */ var _server_state_server_state_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./server-state/server-state.module */ "./src/app/server-state/server-state.module.ts");
/* harmony import */ var _overview_overview_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./overview/overview.component */ "./src/app/overview/overview.component.ts");
...
/* harmony import */ var _deployment_deployment_list_deployment_list_pr_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./deployment/deployment-list/deployment-list-pr.component */ "./src/app/deployment/deployment-list/deployment-list-pr.component.ts");
/* harmony import */ var _deployment_deployment_list_deployment_list_rc_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./deployment/deployment-list/deployment-list-rc.component */ "./src/app/deployment/deployment-list/deployment-list-rc.component.ts");
...
var appRoutes = [
    { path: 'login', component: _authorization_login_login_component__WEBPACK_IMPORTED_MODULE_8__["LoginComponent"], data: { redirectOnLogin: 'deployments/pull-request' } },
    { path: 'deployments/pull-request', component: _deployment_deployment_list_deployment_list_pr_component__WEBPACK_IMPORTED_MODULE_17__["DeploymentListPullRequestComponent"], canActivate: [_authorization_login_guard__WEBPACK_IMPORTED_MODULE_12__["LoginGuard"]] },
    { path: 'deployments/release-candidate', component: _deployment_deployment_list_deployment_list_rc_component__WEBPACK_IMPORTED_MODULE_18__["DeploymentListReleaseCandidateComponent"], canActivate: [_authorization_login_guard__WEBPACK_IMPORTED_MODULE_12__["LoginGuard"]] },
    { path: 'deployments/:deploymentType', component: _deployment_deployment_list_deployment_list_component__WEBPACK_IMPORTED_MODULE_11__["DeploymentListComponent"], canActivate: [_authorization_login_guard__WEBPACK_IMPORTED_MODULE_12__["LoginGuard"]] },
    { path: 'servers', component: _server_state_server_state_list_server_state_list_component__WEBPACK_IMPORTED_MODULE_13__["ServerStateListComponent"], canActivate: [_authorization_login_guard__WEBPACK_IMPORTED_MODULE_12__["LoginGuard"]] },
    { path: 'overview', component: _overview_overview_component__WEBPACK_IMPORTED_MODULE_15__["OverviewComponent"], canActivate: [_authorization_login_guard__WEBPACK_IMPORTED_MODULE_12__["LoginGuard"]] },
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                _deployment_deployment_module__WEBPACK_IMPORTED_MODULE_10__["DeploymentModule"],
                _server_state_server_state_module__WEBPACK_IMPORTED_MODULE_14__["ServerStateModule"]
            ],
            providers: [
                { provide: _angular_core__WEBPACK_IMPORTED_MODULE_2__["APP_INITIALIZER"], useFactory: initializeApp, deps: [_common_api_service__WEBPACK_IMPORTED_MODULE_9__["Api"]], multi: true }
            ],
...
/* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./user.service */ "./src/app/authorization/user.service.ts");
...
module.exports = ".login-container {\n  padding: 48px 40px 36px;\n  margin: 0 auto;\n  border: 1px solid #dadce0;\n  width: 450px;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<div class=\"login-container\" role=\"presentation\">\n  <div id=\"googleBtn\"></div>\n</div>\n"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(userService, route, router, zone) {
        this.userService = userService;
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]])
    ], LoginComponent);
...
var UserService = /** @class */ (function () {
    function UserService(api, config, localStorageService, router, zone) {
        this.api = api;
        this.config = config;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        _a = this;
                        return [4 /*yield*/, swagger_client_browser__WEBPACK_IMPORTED_MODULE_2___default()(this.config.apiUrl, {
...
var ColumnFactory = /** @class */ (function () {
    ...
    ColumnFactory.getPullRequestColumns = function () {
        return [
            ...
            SharedColumn.VERSION,
            {
                field: 'pullRequestMeta.jiraLink', header: 'Jira number', isEditable: false, renderer: function (row) {
                    if (!row.pullRequestMeta) {
                        return '';
                    }
                    return "<a target=\"_blank\" href=\"" + row.pullRequestMeta.jiraLink + "\">" + row.pullRequestMeta.jiraTaskKey + "</a>";
                }
            },
...
module.exports = ".edit-column {\n  width: 8em; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var DeploymentListComponent = /** @class */ (function () {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        deploymentContext = _a.sent();
                        this.serverTagOptions = deploymentContext.connectedServers.reduce(function (tags, server) {
                            tags.push({
                                value: server.tag,
                                label: server.tag
                            });
    ...
    DeploymentListComponent.prototype.loadDeployments = function (_a) {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var isPullRequestDeployment, isReleaseCandidate, query, pageNumber, pageResult;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    function ServerStateListComponent(deploymentService) {
        this.cols = [
            ...
            { field: 'version', header: 'Installed version', isEditable: false, renderer: function (_a) {
                    ...
                    if (pr) {
                        return version + "-prid-" + pr.pullId + "/" + pr.jiraTaskKey;
                    }
                    return version;
                } },
...
function formatDeploymentVersion(version, pullRequestMeta) {
    if (pullRequestMeta) {
        return version + "-prid-" + pullRequestMeta.pullId + "/" + pullRequestMeta.jiraTaskKey;
    }
    return version;
}
...
module.exports = __webpack_require__(/*! /Users/lucaalexandru/workspace/hermes/hermes-packages/hermes-packages-www/src/main.ts */"./src/main.ts");
